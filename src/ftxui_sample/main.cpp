...
// configuration step. It creates a namespace called `cppweekly_rpg`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cppweekly_rpg::cmake::project_name, cppweekly_rpg::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cppweekly_rpg::cmake::project_version);
      return EXIT_SUCCESS;
    }
